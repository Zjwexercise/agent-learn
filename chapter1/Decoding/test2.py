...
print("正在运行 Beam Search (束搜索: 2 beams, 4 steps)...")
result = client.predict(
    input_text="France's capital city is",
    number_steps=2,
    number_beams=5,
    length_penalty=1,
...
save_and_open_html(
    ...
    output_filepath="test2_beam_search_b2.html",
    title="测试 2：束搜索 (Beam Search: beams=2) 解码过程",
    auto_open=True
)