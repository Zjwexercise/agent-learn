...
* **大模型底座**：智谱 AI (GLM-4 / GLM-4-Flash)
* **技术栈**：Python 3.10+ · smolagents · Gradio · ZhipuAI
* **开发者**：Zjwexercise
...
| :--- | :--- | :--- | :--- |
| 📖 [**`chapter1/`**](chapter1/README.md) | **Unit 1: 智能体基础与工具初识** | 手搓白盒 ReAct 闭环、CodeAgent 代码块范式、官方 Space 模板工程化与 7 大工具拓展 | ✅ 已完成 |
